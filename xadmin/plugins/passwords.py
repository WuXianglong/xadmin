...
class ResetLinkPlugin(BaseAdminPlugin):
    ...
    def block_form_bottom(self, context, nodes):
        ...
        return '<div class="text-info" style="margin-top:15px;"><a href="%s"><i class="fa fa-question-sign">' \
               '</i> %s</a></div>' % (reset_link, _('Forgotten your password or username?'))
...
site.register_view(r'^xadmin/password_reset/(?P<uidb36>[0-9A-Za-z]{1,13})-'
